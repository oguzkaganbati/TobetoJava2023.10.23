...
import com.tobeto.pair5.services.dtos.user.responses.GetByEmailResponse;
...
public class UserManager implements UserService {
    ...
    public GetByEmailResponse getByEmail(String email) {
        ...
        GetByEmailResponse response = this.modelMapperService.forResponse().map(user, GetByEmailResponse.class);
        return response;
    }
}
